                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              if (controller.a_room.value == 0) {
                                controller.a_room.value = 1;
                              } else {
                                controller.a_room.value = 0;
                              }
                            },
                            child:
                          Container(
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              if (controller.shared_room.value == 0) {
                                controller.shared_room.value = 1;
                              } else {
                                controller.shared_room.value = 0;
                              }
                            },
                            child:
                          Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Guests may sleep in a room or common area that may be shared with you or others",
                                          style: TextStyle(
                                              fontWeight: FontWeight.normal,
                                              fontSize: 12,
                                              color: Colors.black54),
