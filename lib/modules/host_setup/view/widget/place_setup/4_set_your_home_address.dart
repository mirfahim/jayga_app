                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: DropdownSearch<String>(
                                ...
                                items: Get.find<BookingController>().getAllDistrict.isNotEmpty
                                    ? Get.find<BookingController>().getAllDistrict
                                    .map((item) => item.name!)
                                    .toList()
                                    : [],
                                onChanged: (input) {
                                  for (var item in Get.find<BookingController>().getAllDistrict) {
                                    if (item.name == input) {

                                      controller.districtId.value =
                                          item.id.toString();
                                      print("my district id is ${controller.districtId.value} ad input is $input");
                                      Get.find<BookingController>().getArea(controller.districtId.value);
                                      print("area list ${Get.find<BookingController>().areaListByDis.value} ad input is $input");
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: DropdownSearch<String>(
                                ...
                                // ),
                                showSelectedItems: true,
                                items: Get.find<BookingController>().areaListByDis
                                    .isNotEmpty
                                    ? Get.find<BookingController>().areaListByDis
                                    .map((item) => item.name!)
                                    .toList()
                                    : [],
                                onChanged: (input) {},
