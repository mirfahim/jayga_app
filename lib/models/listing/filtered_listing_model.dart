...
class FilteredListing {
  ...
  factory FilteredListing.fromJson(Map<String, dynamic> json) => FilteredListing(
    ...
    listerName: json["lister_name"] ?? "No Data",
    nidNumber: json["nid_number"] ?? "0000000000",
    guestNum: json["guest_num"] ?? "0",
    bedNum: json["bed_num"] ?? "0",
    bathroomNum: json["bathroom_num"] ?? "0",
    listingTitle: json["listing_title"],
    listingDescription: json["listing_description"],
    videoLink: json["video_link"] ?? "https://flutter.github.io/assets-for-api-docs/assets/videos/bee.mp4",
    ...
    describePeaceful: json["describe_peaceful"]??"0",
    describeUnique: json["describe_unique"]??"0",
    describeFamilyfriendly: json["describe_familyfriendly"]??"0",
    describeStylish: json["describe_stylish"]??"0",
    describeCentral: json["describe_central"]??"0",
    describeSpacious: json["describe_spacious"]??"0",
    privateBathroom: json["private_bathroom"]??"0",
    doorLock: json["door_lock"]??"0",
